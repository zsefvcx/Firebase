...
PurchasesList _$PurchasesListFromJson(Map<String, dynamic> json) {
  return _PurchasesList.fromJson(json);
}

/// @nodoc
mixin _$PurchasesList {
  List<Purchase> get purchases => throw _privateConstructorUsedError;

  Map<String, dynamic> toJson() => throw _privateConstructorUsedError;
  @JsonKey(ignore: true)
  $PurchasesListCopyWith<PurchasesList> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $PurchasesListCopyWith<$Res> {
  factory $PurchasesListCopyWith(
          PurchasesList value, $Res Function(PurchasesList) then) =
      _$PurchasesListCopyWithImpl<$Res, PurchasesList>;
  @useResult
  $Res call({List<Purchase> purchases});
}

/// @nodoc
class _$PurchasesListCopyWithImpl<$Res, $Val extends PurchasesList>
    implements $PurchasesListCopyWith<$Res> {
  _$PurchasesListCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$_PurchasesListCopyWith<$Res>
    implements $PurchasesListCopyWith<$Res> {
  factory _$$_PurchasesListCopyWith(
          _$_PurchasesList value, $Res Function(_$_PurchasesList) then) =
      __$$_PurchasesListCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call({List<Purchase> purchases});
}
...
/// @nodoc
class __$$_PurchasesListCopyWithImpl<$Res>
    extends _$PurchasesListCopyWithImpl<$Res, _$_PurchasesList>
    implements _$$_PurchasesListCopyWith<$Res> {
  __$$_PurchasesListCopyWithImpl(
      _$_PurchasesList _value, $Res Function(_$_PurchasesList) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$_PurchasesList with DiagnosticableTreeMixin implements _PurchasesList {
  const _$_PurchasesList({required this.purchases});

  factory _$_PurchasesList.fromJson(Map<String, dynamic> json) =>
      _$$_PurchasesListFromJson(json);
  ...
  void debugFillProperties(DiagnosticPropertiesBuilder properties) {
    ...
    properties
      ..add(DiagnosticsProperty('type', 'PurchasesList'))
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, const DeepCollectionEquality().hash(purchases));

  @JsonKey(ignore: true)
  @override
  @pragma('vm:prefer-inline')
  _$$_PurchasesListCopyWith<_$_PurchasesList> get copyWith =>
      __$$_PurchasesListCopyWithImpl<_$_PurchasesList>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_PurchasesListToJson(
      this,
    );
  }
}

abstract class _PurchasesList implements PurchasesList {
  const factory _PurchasesList({required final List<Purchase> purchases}) =
      _$_PurchasesList;

  factory _PurchasesList.fromJson(Map<String, dynamic> json) =
      _$_PurchasesList.fromJson;
